package src3d.models.soccer.equipment {
	...
	public class Goal extends Equipment {
		...
		public const _equipmentLibraryId:int = EquipmentLibrary.ID_009;
		
		public function Goal(sessionScreen:SessionScreen, objSettings:SSPObjectBaseSettings) {
			...
			this.name = EquipmentLibrary.NAME_GOAL;
			...
			this._internalScale = 1.08;
			this.controllerScale = 1.4;
			//this.shadow.shadowScale(4,1.5);
			//this.shadow.scale(.5);
			this.useShadow = false;
			
			this._resizable = true;
			this.minSize = .75; // Goal to Scale.
			this.maxSize = 1.33; // Max Size.
