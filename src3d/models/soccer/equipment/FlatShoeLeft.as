package src3d.models.soccer.equipment {
	...
	public class FlatShoeLeft extends Equipment {
		[Embed(source="FlatShoeLeft.3ds", mimeType="application/octet-stream")]
		private var Object1a:Class;
		
		private var objSettingsRef:EquipmentSettings;
		public const _equipmentLibraryId:int = EquipmentLibrary.ID_032;
		
		public function FlatShoeLeft(sessionScreen:SessionScreen, objSettings:SSPObjectBaseSettings) {
			...
			this.name = EquipmentLibrary.NAME_FLAT_SHOE_LEFT;
		...
		private function initObject():void {
			...
			objContainer.name = EquipmentLibrary.NAME_FLAT_SHOE_LEFT;
