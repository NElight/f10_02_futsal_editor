package src3d.models.soccer.equipment {
	...
	public class Disc extends Equipment {
		[Embed(source="SoccerDisc.3ds", mimeType="application/octet-stream")]
		private var Object1a:Class;
		
		private var objSettingsRef:EquipmentSettings;
		public const _equipmentLibraryId:int = EquipmentLibrary.ID_006;
		
		public function Disc(sessionScreen:SessionScreen, objSettings:SSPObjectBaseSettings) {
			...
			this.name = EquipmentLibrary.NAME_DISC;
			...
			this._internalScale = .12;
			//this.controllerScale = 4;
			//this.shadow.scaleZ = .6;
			this.shadow.shadowScale(8, 8);
		...
		private function initObject():void {
			...
			this._mainContainerHeight = 26;
		}
		
		protected override function setMaterials():void {
			var obj1_BitmapData:BitmapData = EquipmentTextures.getInstance().disc_Bmd;
			obj1_BitmapData = ColorUtils.colorBmp(obj1_BitmapData, _color1);
			ColorUtils.applyMaterialToMesh(objectSet, obj1_BitmapData, "disc");
		}
	}
}