package src3d.models.soccer.equipment {
	...
	public class PassingArc extends Equipment {
		[Embed(source="PassingArc.3ds", mimeType="application/octet-stream")]
		private var Object1a:Class;
		
		private var objSettingsRef:EquipmentSettings;
		public const _equipmentLibraryId:int = EquipmentLibrary.ID_011;
		
		public function PassingArc(sessionScreen:SessionScreen, objSettings:SSPObjectBaseSettings) {
			...
			this.name = EquipmentLibrary.NAME_PASSING_ARC;
