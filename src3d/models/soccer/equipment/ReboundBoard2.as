package src3d.models.soccer.equipment {
	...
	public class ReboundBoard2 extends Equipment {
		[Embed(source="ReboundBoard2.3ds", mimeType="application/octet-stream")]
		private var Object1a:Class;
		
		private var objSettingsRef:EquipmentSettings;
		public const _equipmentLibraryId:int = EquipmentLibrary.ID_015;
		
		public function ReboundBoard2(sessionScreen:SessionScreen, objSettings:SSPObjectBaseSettings) {
			...
			this.name = EquipmentLibrary.NAME_REBOUND_BOARD_2;
		...
		private function initObject():void {
			...
			objContainer.name = "ReboundBoard2";
