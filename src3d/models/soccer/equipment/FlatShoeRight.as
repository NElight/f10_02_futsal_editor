package src3d.models.soccer.equipment {
	...
	public class FlatShoeRight extends Equipment {
		[Embed(source="FlatShoeRight.3ds", mimeType="application/octet-stream")]
		private var Object1a:Class;
		
		private var objSettingsRef:EquipmentSettings;
		public const _equipmentLibraryId:int = EquipmentLibrary.ID_033;
		
		public function FlatShoeRight(sessionScreen:SessionScreen, objSettings:SSPObjectBaseSettings) {
			...
			this.name = EquipmentLibrary.NAME_FLAT_SHOE_RIGHT;
		...
		private function initObject():void {
			...
			objContainer.name = EquipmentLibrary.NAME_FLAT_SHOE_RIGHT;
		...
		protected override function setMaterials():void {
			var obj1_BitmapData:BitmapData = EquipmentTextures.getInstance().flat_shoes_Bmd;
			obj1_BitmapData = ColorUtils.colorBmp(obj1_BitmapData, _color1, BlendMode.MULTIPLY, EquipmentTextures.getInstance().flat_shoes_mask_Bmd);
