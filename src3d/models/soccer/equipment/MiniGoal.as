package src3d.models.soccer.equipment {
	...
	public class MiniGoal extends Equipment {
		[Embed(source="MiniGoal.3ds", mimeType="application/octet-stream")]
		private var Object1a:Class;
		
		private var objSettingsRef:EquipmentSettings;
		public const _equipmentLibraryId:int = EquipmentLibrary.ID_010;

		public function MiniGoal(sessionScreen:SessionScreen, objSettings:SSPObjectBaseSettings) {
			...
			this.name = EquipmentLibrary.NAME_MINIGOAL;
		...
		private function initObject():void {
			...
			objContainer.name = "MiniGoal";
			//objContainer.rotationX = 90;
			//objContainer.rotationY = this.rotationY * -1;
		...
		protected override function setMaterials():void {
			...
			ColorUtils.applyMaterialToMesh(objectSet, obj2_BitmapData, "posts");
		}
	}
}