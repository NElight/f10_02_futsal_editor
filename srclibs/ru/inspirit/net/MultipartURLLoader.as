package ru.inspirit.net
{
	...
	{
		public static var BLOCK_SIZE:uint = 32 * 1024;
		...
		private function addListener(): void
		{
			...
			_loader.addEventListener( Event.OPEN, onOpen, false, 0, false );
			_loader.addEventListener( ProgressEvent.PROGRESS, onProgress, false, 0, false );
			_loader.addEventListener( ProgressEvent.SOCKET_DATA, onSocketData, false, 0, false );
		...
		private function removeListener(): void
		{
			...
			_loader.removeEventListener( ProgressEvent.SOCKET_DATA, onSocketData );
		...
		private function nextAsyncLoop():void
		{
			...
			if (asyncFilePointer < _fileNames.length) {
				...
				dispatchEvent( new MultipartURLLoaderEvent(MultipartURLLoaderEvent.DATA_PREPARE_COMPLETE, totalFilesSize, totalFilesSize) );
			}
		}
